...
},{"react/dist/react.min":11}],3:[function(require,module,exports){
"use strict";
...
},{"../jsx/Positionable.jsx":4,"./Log.jsx":1,"./TextField.jsx":2,"react/dist/react.min":11}],4:[function(require,module,exports){
"use strict";
...
*/
  ...
  touchStart: function(evt) { evt = evt.nativeEvent; document.dispatchEvent (new CustomEvent("app:log", {detail: { msg: "touch start " + evt.touches[0].pageX + "/" + evt.touches[0].pageY }})); },
  touchMove: function(evt) { evt = evt.nativeEvent; document.dispatchEvent (new CustomEvent("app:log", {detail: { msg: "touch move " + evt.touches[0].pageX + "/" + evt.touches[0].pageY }})); },
  touchEnd: function(evt) { evt = evt.nativeEvent; document.dispatchEvent (new CustomEvent("app:log", {detail: { msg: "touch end " + evt.touches[0].pageX + "/" + evt.touches[0].pageY }})); },
...
},{"./RotationController.jsx":5,"./ScaleController.jsx":6,"./Transform-mixin":7,"./ZIndexController.jsx":8,"classnames":9,"react/dist/react.min":11}],5:[function(require,module,exports){
"use strict";
...
},{"./Transform-mixin":7,"react/dist/react.min":11}],6:[function(require,module,exports){
"use strict";
...
},{"./Transform-mixin":7,"react/dist/react.min":11}],7:[function(require,module,exports){
"use strict";
...
},{"react-onclickoutside":10}],8:[function(require,module,exports){
"use strict";
  ...
  render: function() {
    return (
      React.createElement("div", {className: "zindex-controller"}, 
        "layer position: ", React.createElement("span", {className: "zmod", onClick: this.zDown}, "◀"), " ", this.state.zIndex, " ", React.createElement("span", {className: "zmod", onClick: this.zUp}, "▶")
      )
    );
  },
...
},{"react/dist/react.min":11}],9:[function(require,module,exports){
function classNames() {
	var classes = '';
	var arg;
